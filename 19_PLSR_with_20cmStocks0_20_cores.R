...
cstocks_data$depth <- droplevels(cstocks_data$depth)
...
train.data$scoresPlsr1 <- model.initial$finalModel$scores[1:250,1]
...
ggsave(filename = "~/Desktop/PanelPLSR_sizedNODEPTH_NOPOSI.pdf", width = 185, height = 185, units = "mm")
